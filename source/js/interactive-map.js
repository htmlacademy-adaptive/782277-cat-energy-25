...
let interactiveMap = map.querySelector('.map__interactive');
interactiveMap.classList.add('map__interactive--disabled');
...
map.addEventListener('click', function () {
  interactiveMap.classList.remove('map__interactive--disabled');
